    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if publisher is None:
                messages.success(request, "Wydawnictwo {} zostało utworzone.".format(updated_publisher))
            else:
                messages.success(request, "Wydawnictwo {} zostało zaktualizowane.".format(updated_publisher))
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if review is None:
                ...
                messages.success(request, "Zaktualizowno recenzję książki {}".format(book))
...
def book_media(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            book.save()
            messages.success(request, "Książka {} została zaktualizowana.".format(book))
            return redirect("book_detail", book.pk)
    else:
