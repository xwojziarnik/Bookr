...
from .views import BookCreateView, FormSuccessView, BookUpdateView, BookDeleteView, BookRecordDetailView
...
urlpatterns = [
    ...
    path('book-record-detail/<int:pk>/', BookRecordDetailView.as_view(), name="book_detail")
]
